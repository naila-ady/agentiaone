    ...
    return (
       ...
       px-2 ml-2  items-center '>
                    ...
                    <ul className='max-w-[615px] h-[64px] py-4 text-[16px] text-[#FFFFFF] hidden md:flex gap-2 list-none '>
                        <Link href={"#Features"} className="px-4 text-1xl hover:text-[#D1D5Db]">
                            Features
                        </Link>
                        <Link href={"#AdvancedAi"} className="px-4 text-1xl hover:text-[#D1D5Db]">
                            Techonolgy
                        </Link>
                        <Link href={"#Aisolutions"} className="px-4 text-1xl hover:text-[#D1D5Db]">
                            Agents
                        </Link>
                        <Link href={"#ChoosePlan"} className="px-4 text-1xl hover:text-[#D1D5Db]">
                            Pricing
                        </Link>
                ...
                <Sheet>
                    ...
                    <SheetContent className='bg-black/80'>
                        <ul className="flex flex-col gap-4 list-none ">
                            <Link href={"#Features"} className="px-4 text-1xl text-purple-500 hover:text-[#D1D5Db]">
                                Features
                            </Link>
                            <Link href={"#AdvancedAi"} className="px-4 1xl text-purple-500 text-1xl hover:text-[#D1D5Db]">
                                Techonolgy
                            </Link>
                            <Link href={"#Aisolutions"} className="px-4 1xl text-purple-500 text-1xl hover:text-[#D1D5Db]">
                                Agents
                            </Link>
                            <Link href={"#ChoosePlan"} className="px-4 1xl text-purple-500 text-1xl hover:text-[#D1D5Db]">
                                Pricing
                            </Link>
